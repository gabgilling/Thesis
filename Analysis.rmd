...
census2011_education$NUTS <- census2011_education$GEO


# census2011_education <- merge(census2011_education, nuts_fr, by = "NUTS2", all.x = TRUE)

census2011_education <- merge(reg_preds %>% dplyr::select(NUTS, Region.Name),census2011_education, by = "Region.Name")
